...
import { runExtras } from "./extras.mjs";
...
**Keep the index fresh — re-run when you notice any of these:**
- A symbol you looked up doesn't match what's in the source file
- An import path in \`import_graph.json\` points to a file that no longer exists
- \`dead_code.json\` or \`api_surface.json\` lists symbols you know were removed
- The file count or symbol count looks stale compared to the actual repo

To regenerate: \`npx wkix generate --force\` or \`bunx wkix generate --force\`

> Generated by \`wkix generate\` on ${new Date().toISOString().slice(0, 10)}.
`;
}
